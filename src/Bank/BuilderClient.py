...
class BuilderClient:
    ...
    def secondName(self, second_name: str):
        """Устанавливает фамилию для будущего объекта-клиента, возвращает
        ссылку на себя же для дальнейшей "настройки" объекта строителя"""
    ...
    def passport(self, series: int, number: int):
        """Устанавливает паспорт для будущего объекта-клиента, возвращает
        ссылку на себя же для дальнейшей "настройки" объекта строителя"""
    ...
    def check(self):
        """Проверка обязательных условий (имя и фамилия должны быть
        установлены) для создания объекта-клиента"""
